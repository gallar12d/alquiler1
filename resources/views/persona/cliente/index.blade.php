    ...
    <table class="table table-striped datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{ url('/persona/editar/'.$per->id.'/c') }}">Editar </a><br>
                    <!--<a class="eliminarBtn" data-redirect="{{ url('/persona/c')}}" href="{{ url('/persona/eliminar/'.$per->id) }}"> Eliminar</a></td>-->        
            </tr>
            @endforeach
            @else
            No existen clientes
            ...
            <div class="modal-body">
                <form class="formsubmit" method="post" action="{{ url('/persona/crear') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name ="actividad">
                    </div>
                    <div class="form-group">
                        <label for="nombre">Referencia familiar *</label>
                        <input required required type="text" class="form-control" name ="referencia_nombre">
                    </div>
                    <div class="form-group">
                        <label for="nombre">Celular referencia *</label>
                        <input required type="text" class="form-control" name ="referencia_celular">
                    </div>
