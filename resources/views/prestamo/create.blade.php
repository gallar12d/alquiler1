...
<div class="row">
    ...
    <form class="formsubmit" method="post" action="{{ url('/persona/crear') }}">
        ...
        <div class="form-group">            
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select id="tipo_pago" class="form-control" name = 'sede' >
        ...
        <div class="form-group">            
            ...
            <table data-url = "{{url('/prestamo/create')}}" id="tableProductos" class="table table-striped">
        ...
        <div class="col-md-12">
            ...
            <a id="btnCrearcompromiso" class="  col-md-3 btn btn-default ">Realizar préstamo</a>
                ...
                $.get(url).done(function (data) {
                    ...
                    if (data.length == 0) {
                        ...
                        $.each(data, function (k, v) {
                            ...
                            if (data.estado_producto == 'Comprometido' || data.estado_producto == 'Prestado') {
...
//                            }
                            ...
                            var text = '<tr><td data-idproducto ="' + data.idpro + '"><input class="addproduct" type="checkbox" ' + textdisabled + ' value="' + data.idpro + '"></td><td>' + data.nombre + '' + vendido + '</td><td>' + data.talla + '</td><td>' + data.color + '</td><td>' + data.referencia + '</td><td>' + data.estado_producto + '</td><td>' + data.valor + '</td><td>' + data.linea + '</td></tr>'
...
//            }
            ...
            var sede = $('select#tipo_pago option:selected').val()
...
//                    var ajuste = $(this).find('textarea').val();
                ...
                if (!confirm('Está seguro que desea confirmar el préstamo de estos productos?')) {
                    return 0;
                ...
                $.post(url, {'sede': sede, 'total': total, '_token': token, 'id_cliente': id_cliente, 'productos': productosarray}).done(function (data) {
                    ...
                    if (data) {
                        ...
                        if (data == 500) {
                            ...
                            alert('Se ha creado el préstamo correctamente!');
