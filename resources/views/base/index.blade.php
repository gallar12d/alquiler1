...
<div class="row">
    ...
    <div class ="col-md-10 col-md-offset-1">    
        ...
        <form class="col-md-12" method="POST" action="{{url('base/ingresar')}}">
            <div class="form-group col-md-8">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <label for="nombre">Ingresar valor de base</label>
            ...
            <div class="form-group col-md-4">
                ...
                <button type="submit" class="btn btn-default">Ingresar base</button>
