    ...
    <form class="formsubmit" method="post" action="{{ url('/compromiso/entregar') }}">
        ...
        <div class="form-group col-md-6">
            ...
            <select  class="form-control garantiaSelect" name = 'tipo_garantia' >
                ...
                <option value="libreta_militar">libreta militar</option>  
                <option value="tarjeta_profesiona">Tarjeta profesional</option>                  
            </select>
        </div> 
        <div class="form-group col-md-6  valor_garantia">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('button.btnEntrega').on('click', function (e) {
            var elemento = $(this);
            e.preventDefault();
            if (confirm('Está seguro que se han entregado todos los productos al cliente?')) {
