...
<form class="formsubmit" method="post"  data-redirect = "{{ url('/persona/c') }}" action="{{ url('/persona/editar') }}">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input required type="number" value="{{$persona->cedula}}" class="form-control" name ="cedula">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input required type="email" value="{{$persona->email}}" class="form-control" name ="email">
        </div>
        <div class="form-group">
          <label for="nombre">Teléfono</label>
          <input  type="number" value="{{$persona->telefono}}" class="form-control" name ="telefono">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input  type="text" class="form-control" value="{{$persona->actividad}}" name ="actividad">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input required type="number" class="form-control" value="{{$persona->referencia_celular}}" name ="referencia_celular">
        </div>
