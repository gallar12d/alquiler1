...
<div class = "col-md-8 col-md-offset-2">
    ...
    <form class="formsubmit" method="post"  data-redirect = "{{ url('/inventario') }}" action="{{ url('/inventario/editar') }}">
        ...
        <div class="form-group">
            ...
            <input  type="text" class="form-control" value = '{{$producto->referencia}}' name ="referencia">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input required type="number" value = '{{$producto->valor}}' class="form-control" name ="valor">
        </div>
        <div class="form-group">
