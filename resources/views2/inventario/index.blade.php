    ...
    <table class="table table-striped datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{ url('/inventario/editar/'.$producto->id) }}">Editar </a><br><a class="eliminarBtn" data-redirect="{{ url('/inventario')}}" href="{{ url('/inventario/eliminar/'.$producto->id) }}"> Eliminar</a></td>        
            </tr>
            @endforeach
            @else
